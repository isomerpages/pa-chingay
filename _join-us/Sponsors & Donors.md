...
<div style="margin: 0 auto; display: grid; grid-gap: 0.5rem; grid-template-columns: repeat(auto-fit, minmax(170px,1fr)); padding-top:3%; padding-bottom:3%;align-items: center;">
